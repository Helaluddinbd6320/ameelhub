    ...
    <div class="ameelhub-ticker">
        <div class="ameelhub-ticker__track">
            <span class="ameelhub-ticker__item">
                {{ $tickerMessage }}
                @if ($tickerWhatsapp)
                    <a href="https://wa.me/{{ preg_replace('/\D/', '', $tickerWhatsapp) }}" target="_blank" rel="noopener"
            ...
            <span class="ameelhub-ticker__item" aria-hidden="true">
                {{ $tickerMessage }}
                @if ($tickerWhatsapp)
                    <a href="https://wa.me/{{ preg_replace('/\D/', '', $tickerWhatsapp) }}" target="_blank"
                        rel="noopener" class="ameelhub-ticker__link" tabindex="-1">
                        {{ $tickerWhatsapp }}
                    </a>
                @endif
            </span>
