...
@if($mobile)
    {{-- Step: new-locales — the native <select> approach had iOS rendering
    issues (icon overlapping truncated option text, native arrow showing
    alongside the custom chevron). Reusing the same <x-dropdown> trigger as
    desktop is simpler and avoids all of that, since it's already known to
    render correctly. --}}
