...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Noto+Serif+Bengali:wght@500;700&family=Hind+Siliguri:wght@400;500;600&display=swap" rel="stylesheet">
...
<body class="antialiased" style="font-family: 'Hind Siliguri', sans-serif;">
    ...
    <nav x-data="{ open: false }" class="bg-white border-b border-gray-100 relative z-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-6 rtl:space-x-reverse sm:-my-px sm:ms-10 sm:flex">
                        <a href="{{ route('workers.index') }}"
                           ...
                           style="color:#4b5563;"
                           onmouseover="this.style.color='#0B4F3F'" onmouseout="this.style.color='#4b5563'">
                            কর্মীদের তালিকা
                        </a>
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6 gap-3">
                    <a href="{{ route('login') }}"
                       class="text-sm font-medium px-3 py-2 transition-colors"
                       style="color:{{ request()->routeIs('login') ? '#0B4F3F' : '#4b5563' }};"
                       onmouseover="this.style.color='#0B4F3F'" onmouseout="this.style.color='{{ request()->routeIs('login') ? '#0B4F3F' : '#4b5563' }}'">
                        লগইন
                    </a>
                ...
                <div class="-me-2 flex items-center sm:hidden">
                    <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition duration-150 ease-in-out">
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden border-t border-gray-100">
            <div class="pt-2 pb-3 space-y-1 px-4">
                <a href="{{ route('workers.index') }}" class="block py-2 text-sm font-medium text-gray-600">কর্মীদের তালিকা</a>
    ...
    {{-- ============ HERO + GLASS CARD ============ --}}
    <div class="min-h-[calc(100vh-4rem)] relative flex flex-col items-center justify-center px-4 py-10 overflow-hidden" style="background: linear-gradient(160deg, #0B4F3F 0%, #123f33 60%, #0a3529 100%);">

        <div class="pointer-events-none absolute inset-0" style="background: radial-gradient(circle at 12% 15%, rgba(201,151,76,0.30), transparent 42%), radial-gradient(circle at 88% 85%, rgba(255,255,255,0.08), transparent 45%);"></div>
        <div class="pointer-events-none absolute inset-0 opacity-[0.07]" style="background-image: radial-gradient(circle at 1px 1px, white 1px, transparent 0); background-size: 26px 26px;"></div>
